...
function vpgb_js () {
  ...
  $js = "
    ...
    if (action == \"url\") {
        var thisURL = prompt(\"URL der gew�nschten Seite angeben\", \"http://\");
    ...
    if (action == \"email\") {
        var thisEmail = prompt(\"gew�nschte E-Mail-Adresse angeben\", \"\");
...
global $emails_an, $userfeld1, $userfeld2, $userfeld3;
  ...
  $mailtext = "Es gibt einen neuen Eintrag im G�stebuch:
...
";
  ...
  $mail->From     = $emails_an;
  $mail->FromName = "G�stebuch";
  $mail->Subject  = "Neuer G�stebucheintrag";
  $mail->Body     = $mailtext;
  if(!$mail->Send()){
...
global $db, $cfg, $client, $lang, $idart, $direkt_sichtbar, $email_benachrichtigung, $smilies_aktiv, $bbcode_aktiv, $bilder, $xhtml;
  ...
  if (($_POST['email'] == "") || (preg_match($email_pattern, $_POST['email']))) {
    ...
    $error = "Bitte geben Sie eine g�ltige Email-Adresse an!";
  }
...
if ($_POST) {
  ...
  elseif ($direkt_sichtbar) {
    echo "<p>Vielen Dank f�r Ihren Eintrag!</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>";
    $formular_anzeigen = FALSE;
    if ($cookie_aktiv) cookie_setzen ($cookie_dauer);
  }
  else {
    echo "<p>Vielen Dank f�r Ihren Eintrag! Dieser wird nach Pr�fung freigeschaltet.</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>";
    $formular_anzeigen = FALSE;
    if ($cookie_aktiv) cookie_setzen ($cookie_dauer);
  }
}
